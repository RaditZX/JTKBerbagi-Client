    ...
    <React.Fragment>
      <Routes>
        ...
        <Route
          ...
          element={
            <Layout
              isPenanggungJawabJtkBerbagi={true}
              isPenanggungJawabPihakJurusan={false}
        ...
        >
          ...
          <Route
            path="/calonpenerimabeasiswa"
            element={<CalonPenerimaBeasiswa />}
          />
          <Route
            path="/calonpenerimanonbeasiswa"
          ...
          />
          <Route
            path="/rekapitulasi-dana/beasiswa"
            element={<LaporanRekapitulasiBeasiswa />}
          />
          <Route
        ...
        <Route
          ...
          element={
            <Layout
              isPenanggungJawabJtkBerbagi={true}
              isPenanggungJawabPihakJurusan={true}
              isLogin={localStorage.getItem("token") !== null}
            />
          }
        >
          ...
          <Route
            path="/penerima-dana/beasiswa"
            element={<PenerimaBeasiswa />}
          />
          <Route
            path="/penerima-dana/non-beasiswa"
            element={<PenerimaNonBeasiswa />}
          />
        </Route>
        ...
        <Route path="/" element={<LayoutUser />}>
          ...
          <Route
            path="/rekapitulasi-dana-public"
            element={<RekapitulasiDana />}
          />
        </Route>
      </Routes>
    </React.Fragment>
