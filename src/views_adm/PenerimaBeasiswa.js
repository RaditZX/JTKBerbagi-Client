...
function BantuanBeasiswa() {
  ...
  const [openModalDataPerkuliahan, setOpenModalDataPerkuliahan] =
    useState(false);
  const handleOpen = () => {
    setOpen(true);
  };
  ...
  const headers = [
    ...
    {
      title: "No Telepon Mahasiswa",
      id: "nomor_telepon",
      parentId: "mahasiswa",
    },
    {
      title: "Status Kehadiran Perkuliahan",
      id: "status_kehadiran_perkuliahan",
    },
    {
      title: "Dokumen Kehadiran Perkuliahan",
      id: "dokumen_kehadiran_perkuliahan",
    },
    ...
    >
      ...
      >
        ...
        <Typography variant="h4" sx={{ ml: 1 }}>
          Daftar Penerima Bantuan Dana Beasiswa
        </Typography>
      </Box>
                    ...
                    {Object.entries(headers).map(([key, val]) => (
                      <StyledTableCell sx={{ textAlign: "center" }}>
                        {val.id === "dokumen_kehadiran" ? (
                          ...
                          <Box>
                            <Button onClick={handleOpenModalDataPerkuliahan}>
                              Open
                            </Button>
                            <Modal
                    ...
                    <StyledTableCell>
                      ...
                      <Modal open={openModal} onClose={handleCloseModal}>
                        <Box sx={styleBox}>
                          <Box sx={{ p: 2 }}>
                            <Typography>
                              Dokumen kehadiran sudah tersedia, silahkan cek
                              kembali!
                            </Typography>
                          </Box>
                        </Box>
                        ...
                        <Box sx={styleBox}>
                          ...
                          >
                            <Typography sx={{ color: "white" }}>
                              Formulir Kehadiran Perkuliahan Penerima Beasiswa
                            </Typography>
                          </Box>
                          <Box sx={{ p: 2, display: "flex" }}>
                            <Box sx={{ width: "100%" }}>
                              ...
                              <TextField
                                ...
                                sx={{ width: "100%" }}
                                onChange={(val) => {
                                  handleStatusKehadiranChange(val.target.value);
                                }}
                              >
                                {selectStatusKehadiran.map((option) => (
                                  <MenuItem
                                    key={option.value}
                                    value={option.value}
                                  >
