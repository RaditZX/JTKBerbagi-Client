...
import { ExportPenerimaNonBeasiswaButtonWithValidation } from "../components/export/exportPenyaluranBeasiswaToPDF";
...
function LaporanRekapitulasiNonBeasiswa() {
  ...
  const [penerimaNonBeasiswa, setPenerimaNonBeasiswa] = useState([]);
  ...
  const headers = [
    ...
    {
      title: "No Telepon Penerima",
      id: "nomor_telepon",
      parentId: "penerima_non_beasiswa",
    },
    {
      title: "Nama Penanggung Jawab",
      id: "nama",
      parentId: "penanggung_jawab_non_beasiswa_id",
    },
    {
    ...
    await fetch(
      ...
      .then((data) => {
        ...
        if (data.response_code === 200) {
          ...
          setPenerimaNonBeasiswa(arrayData);
        } else {
                  ...
                  <StyledTableRow key={index}>
                      ...
                      <StyledTableCell sx={{ textAlign: "center" }}>
                        {val.id === "status" ? (
                          <Button
                            ...
                            variant="outlined"
                            color={
                              row.status_penyaluran === 0 ? "error" : "success"
                            }
                            sx={{
                              backgroundColor: (theme) =>
                                row.status_penyaluran === 0
                    ...
                    >
                      <Button
                        ...
                        color="primary"
                        onClick={(val) => {
                          getRekapitulasiNonBeasiswaDetails(
    ...
    >
      ...
      >
        ...
        <Typography variant="h4" sx={{ ml: 1 }}>
          Laporan Rekapitulasi Dana Non Beasiswa
        </Typography>
      </Box>
      <Box sx={{ mt: 2, display: "flex", justifyContent: "space-between" }}>
        <TextField
          ...
          size="small"
        ></TextField>
        <ExportPenerimaNonBeasiswaButtonWithValidation
          penerimaNonBeasiswa={penerimaNonBeasiswa}
        />
      </Box>
      {step === 0
        ? renderRekapitulasiNonBeasiswa()
        : renderDetailsRekapitulasiNonBeasiswa()}
    </Container>
  );
}
